...
class Currency (value: BigDec, val currencyCode: String, val decimals: Int,
                val roundingMode: Currency.RoundingMode.Value) extends Ordered[Currency] with Serializable {
...
object Currency {
  ...
  @SerialVersionUID(100L)
  object RoundingMode extends Enumeration with Serializable {
  ...
  private val currencies = Map(
    ...
    "AMD" -> ("Õ¤Ö€",     51, 0, "Luma",         "Armenian Dram", "AM"),
    "ANG" -> ("Æ’",    532, 2, "Cent",         "Netherlands Antillean Guilder", "AN"),
    "AOA" -> ("Kz",   973, 1, "CÃªntimo",      "Kwanza", "AO"),
    "ARS" -> ("$",     32, 2, "Centavo",      "Argentine Peso", "AR"),
    "AUD" -> ("$",     36, 2, "Cent",         "Australian Dollar", "AU"),
    "AWG" -> ("Æ’",    533, 2, "Cent",         "Aruban Florin", "AW"),
    "AZN" -> ("",     944, 2, "QÉ™pik",        "Azerbaijanian Manat", "AZ"),
    "BAM" -> ("ÐšÐœ",   977, 2, "Fening",       "Convertible Marks", "BA"),
    "BBD" -> ("$",     52, 2, "Cent",         "Barbados Dollar", "BB"),
    "BDT" -> ("à§³",     50, 2, "Paisa",        "Bangladeshi Taka", "BD"),
    "BGN" -> ("Ð»Ð²",   975, 2, "Stotinka",     "Bulgarian Lev", "BG"),
    ...
    "CNY" -> ("Â¥",    156, 1, "Fen",          "Yuan", "CN"),
    "COP" -> ("$",    170, 0, "Centavo",      "Colombian Peso", "CO"),
    "CRC" -> ("â‚¡",    188, 2, "CÃ©ntimo",      "Costa Rican Colon", "CR"),
    "CUP" -> ("$",    192, 2, "Centavo",      "Cuban Peso", "CU"),
    "CVE" -> ("Esc",  132, 2, "Centavo",      "Cape Verde Escudo", "CV"),
    "CZK" -> ("KÄ",   203, 2, "HalÃ©Å™",        "Czech Koruna", "CZ"),
    "DJF" -> ("Fr",   262, 0, "Centime",      "Djibouti Franc", "DJ"),
    "DKK" -> ("kr",   208, 2, "Ã˜re",          "Danish Krone", "DK"),
    "DOP" -> ("$",    214, 2, "Centavo",      "Dominican Peso", "DO"),
    "DZD" -> ("",      12, 2, "Centime",      "Algerian Dinar", "DZ"),
    "EEK" -> ("KR",   233, 2, "Sent",         "Kroon", "EE"),
    "EGP" -> ("Â£",    818, 2, "Piastre",      "Egyptian Pound", "EG"),
    "ERN" -> ("Nfk",  232, 2, "Cent",         "Nakfa", "ER"),
    "ETB" -> ("",     230, 2, "Santim",       "Ethiopian Birr", "ET"),
    "EUR" -> ("â‚¬",    978, 2, "Cent",         "Euro", "AT,BE,CY,ES,FI,FR,DE,GR,IE,IT,LU,MT,NL,PT,SI,SK"),
    "FJD" -> ("$",    242, 2, "Cent",         "Fiji Dollar", "FJ"),
    "FKP" -> ("Â£",    238, 2, "Penny",        "Falkland Islands Pound", "FK"),
    "GBP" -> ("Â£",    826, 2, "Penny",        "Pound Sterling", "UK"),
    "GEL" -> ("áƒš",    981, 2, "Tetri",        "Lari", "GE"),
    "GHS" -> ("â‚µ",    936, 2, "Pesewa",       "Cedi", "GH"),
    "GIP" -> ("Â£",    292, 2, "Penny",        "Gibraltar Pound", "GI"),
    ...
    "HUF" -> ("Ft",   348, 0, "Penny",        "FillÃ©r", "HU"),
    "IDR" -> ("Rp",   360, 0, "Sen",          "Rupiah", "ID"),
    "ILS" -> ("â‚ª",    376, 2, "Agora",        "Israeli New Sheqel", "IL"),
    "INR" -> ("â‚¨",    356, 2, "Penny",        "Paisa", "IN"),
    ...
    "LVL" -> ("Ls",   428, 2, "SantÄ«ms",      "Latvian Lats", "LV"),
    ...
    "MKD" -> ("Ð´ÐµÐ½",  807, 2, "Deni",         "Denar", "MK"),
    "MMK" -> ("K",    104, 0, "Pya",          "Kyat", "MM"),
    "MNT" -> ("â‚®",    496, 2, "MÃ¶ngÃ¶",        "Tugrik", "MN"),
    "MOP" -> ("",     446, 1, "Penny",        "Pataca", "MO"),
    "MRO" -> ("P",    478, 1, "Avo",          "Ouguiya", "MR"),
    "MUR" -> ("â‚¨",    480, 2, "Cent",         "Mauritius Rupee", "MU"),
